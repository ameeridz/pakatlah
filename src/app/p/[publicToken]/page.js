...
export default function PublicDecisionPage() {
  ...
  async function loadParticipantResults() {
    if (!responseToken || isLoadingResults) {
      return;
    }
          ...
          <section className="mt-7 sm:mt-10">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="focus-ring flex size-11 shrink-0 items-center justify-center rounded-xl border border-border bg-card/70 hover:bg-secondary disabled:opacity-60"
                onClick={loadParticipantResults}
              >
                <RefreshCw
            ...
            <p className="mt-5 rounded-2xl border border-border bg-card/70 p-4 text-sm leading-relaxed text-muted-foreground">
